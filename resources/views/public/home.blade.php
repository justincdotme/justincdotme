...
<head>
    ...
    <meta name="geo.position" content="45;-122"/>
    <meta name="ICBM" content="45, -122"/>
    ...
    <link rel="apple-touch-icon" sizes="114x114" href="/images/ico/ico/apple-icon-114x114.png">
        ...
        <div class="collapse navbar-collapse" id="main-navigation">
            <ul class="nav navbar-nav mr-auto">
                ...
                <li class="dropdown nav-item">
                    ...
                    <div class="dropdown-menu work-menu" aria-labelledby="navbarDropdown">
                        <a href="#portfolio" class="scroll dropdown-item">Portfolio</a>
                        <a class="dropdown-item" target="_BLANK" href="https://github.com/justincdotme">Github</a>
                        <a class="dropdown-item" href="/justin-christenson-resume.pdf" target="_BLANK">Resume</a>
                    </div>
                </li>
                <li class="nav-item">
...
<!-- Begin Home page -->
<section id="home" data-type="background" data-speed="5" class="pages buffer-top">
    <div class="container">
        <div class="row">
            <div class="col-12 text-center head-container">
...
<!-- Begin About Page -->
<section id="about" data-type="background" data-speed="10" class="pages buffer-top">
    <section id="bio">
        <div class="container">
            <div class="row">
                <div class="col-12">
                                    ...
                                    <div class="thumbnail">
                                        <a target="_BLANK" href="{{ $project->live_url }}">
                                            @if(null !== $project->images()->first())
                                                <img class="img-fluid" alt="{{ (is_null($project->images()->first())) ? $project->name : $project->images()->first()->alt_text }}" src="{{ $project->images()->first()->image_path }}">
                                            @endif
                                        </a>
                                    </div>
                                </div>
